...
router.beforeEach((to, from, next) => {
  ...
  if (to.meta.title) {
    ...
    if (to.meta.title === str) {
      document.getElementById('top-nav-right').innerHTML = '<img src="/static/images/kf.png" alt="搜索">'
    } else {
      document.getElementById('top-nav-right').innerHTML = '<img src="/static/images/ss.png" alt="搜索">'
    }
