...
router.beforeEach((to, from, next) => {
  ...
  if (to.meta.title) {
    ...
    if (to.meta.title === str1) {
      document.getElementById('top-nav-left').innerHTML = '<img src="/static/topnav/cd.png" alt="客服">'
      document.getElementById('top-nav-right').innerHTML = '<img src="/static/topnav/kf.png" alt="客服">'
    } else if (to.meta.title === str2) {
      document.getElementById('top-nav-right').innerHTML = '<img src="/static/topnav/kf.png" alt="客服">'
      document.getElementById('top-nav-left').innerHTML = '<img src="/static/topnav/kf.png" alt="客服">'
    } else {
