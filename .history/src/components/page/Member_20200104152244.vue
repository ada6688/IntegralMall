    ...
    <div class="member-wrap">
      ...
      <div class="member-signIn">
        <div class="member-signIn-status">
          <!-- 当天签到获取积分 -->
          <div class="member-signIn-status-in">
            <p>+10</p>
            <p>+20</p>
            <p>+30</p>
            <p>+40</p>
          ...
          <!-- 签到进度条 -->
          <div class="member-signIn-status-line">
            <div class="member-signIn-status-1">
              <i class="el-icon-success member-signIn-icon-already"></i>
              <span class="member-signIn-already"></span>
            </div>
          </div>
          <!-- 签到日期 -->
          <div class="member-signIn-status-date">
            <p class="signIn-active">12-20</p>
            <p>12-21</p>
            <p>12-22</p>
            <p>12-23</p>
            <p>12-24</p>
