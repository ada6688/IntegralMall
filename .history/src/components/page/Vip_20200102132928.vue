...
<style>
.container .el-tabs__nav,.el-tabs__nav-wrap{
  width: 100%
}
...
.container .el-tabs--border-card>.el-tabs__header{
  padding: 10px 3.65% 0;
  background: #151515
}
.container .el-tabs--border-card>.el-tabs__header .el-tabs__item:not(.is-disabled):hover{
  color: #ffffff;
}
.container .el-tabs--border-card>.el-tabs__header .el-tabs__item.is-active{
  height: 39px;
  color: #ffffff;
  background: #292C35;
}
...
.container .el-tabs__nav-wrap.is-scrollable{
  padding: 0 20px;
...
.container .el-tabs--border-card>.el-tabs__content {
  margin-top: -2px;
  background: #292C35;
}
.container .el-tabs--border-card>.el-tabs__header .el-tabs__item,.container .el-tabs--top.el-tabs--border-card>.el-tabs__header .el-tabs__item:nth-child(2),.container .el-tabs--top.el-tabs--border-card>.el-tabs__header .el-tabs__item:last-child{
  padding: 2px 4.1% 0;
  height: 62px;
