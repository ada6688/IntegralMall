                      ...
                      <ul>
                          ...
                          <li class="nbaGussSmallBox-team">
                              ...
                              <div class="nbaGussSmallBox-team-left">
                                  <p><img :src="origin + '/' + nbanews.competition.team_one.team_img_url.url" alt="nbanews.competition.team_one.team_name" width="40" height="40"></p>
                          ...
                          <li class="nbaGussSmallBox-team">
                              ...
                              <div class="nbaGussSmallBox-team-right">
                                  <p><img :src="origin + '/' + nbanews.competition.team_two.team_img_url.url" alt="nbanews.competition.team_two.team_name" width="40" height="40"></p>
                      ...
                      <div class="nbaGussBigBox-team">
                          <ul>
                              <li class="nbaGussBigBox-team-1">
                                  <p class="nbaGussBigBox-teamLeftpic" ><img :src="origin + '/' + nbanews.competition.team_one.team_img_url.url" alt="nbanews.competition.team_one.team_name" ></p>
                              ...
                              <li class="nbaGussBigBox-team-3">
                                  <p class="nbaGussBigBox-teamRightpic">
                                      <img :src="origin + '/' + nbanews.competition.team_two.team_img_url.url" alt="nbanews.competition.team_two.team_name" >
                                  </p>
                          ...
                          <ul>
                              <li class="nbaGussBigBox-team-1">
                                  <p class="nbaGussBigBox-teamLeftpic" >
                                    <img :src="origin + '/' + nbanews.competition.team_one.team_img_url.url" alt="nbanews.competition.team_one.team_name" >
                                  </p>
                                  <p class="nbaGussBigBox-teamLeftname">{{nbanews.competition.team_one.team_name}}</p>
  ...
  export default {
      ...
      methods: {
          ...
          getNbaMessage () {
              axios({
                  method: 'get',
                  url: origin + '/api/nba/competition/?format=json',
                  headers: {
          ...
          selectTeamOne (index) {
            ...
            if (window.token == '') {
              ...
              axios({
                method: 'post',
                url: origin + '/api/nba/lottery/?format=json',
                headers: {
                  Authorization: 'Token ' + window.token
                },
                data: {
